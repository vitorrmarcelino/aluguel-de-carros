...
route.put("/upload/:id", upload.single("file"), uploadController.update); //Imagem de perfil
route.put("/upload/delete/:id", uploadController.delete); // Remover imagem de perfil
//Transações
